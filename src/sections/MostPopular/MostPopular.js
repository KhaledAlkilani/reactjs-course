    ...
    <>
        <div className='section-wrapper'>
            ...
            <div className='most-popular-items'>
                ...
                <Card image={popular_02} title="PubG"     category="Steam-X"   rate="4.8"  download="1.1M"/>
                <Card image={popular_03} title="Dota2"    category="Legandary" rate="2.7"  download="5.3M"/>
                ...
                <Card image={popular_06} title="PubG"     category="Steam-X"   rate="4.8"  download="1.1M"/>
                <Card image={popular_03} title="Dota2"    category="Legandary" rate="2.7"  download="5.3M"/>
                <Card image={popular_02} title="CS-Go"    category="Battle S"  rate="3.9"  download="6.1M"/>
            </div>
            </div>
    </>
  )
